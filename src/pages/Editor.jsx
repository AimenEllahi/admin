...
const furnitureColorOptions = [
  {
    name: "Dark Blue and Gray",
    color: "bg-[#375f8d]",
    accentColor: "bg-[#d1d1d1]",
  },
  {
  ...
  {
    name: "Dark Blue and Black",
    color: "bg-[#375f8d]",
    accentColor: "bg-[#1a1818]",
  },
];
        ...
        {colorOptions.map((colorOption) => (
          ...
          >
            ...
            {colorOption.accentColor && (
              <div
                className={`absolute bottom-0 right-0 w-8 h-8 rounded-full ${colorOption.accentColor}`}
              />
            )}
          </div>
        ))}
